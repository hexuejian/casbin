...
import (
	...
	"github.com/hexuejian/casbin/effect"
	"github.com/hexuejian/casbin/log"
	"github.com/hexuejian/casbin/model"
	"github.com/hexuejian/casbin/persist"
	"github.com/hexuejian/casbin/persist/file-adapter"
	"github.com/hexuejian/casbin/rbac"
	"github.com/hexuejian/casbin/rbac/default-role-manager"
...
// InitWithAdapter initializes an enforcer with a database beegoormadapter.
...
// InitWithModelAndAdapter initializes an enforcer with a model and a database beegoormadapter.
func (e *Enforcer) InitWithModelAndAdapter(m model.Model, adapter persist.Adapter) {
	...
	// Do not initialize the full policy when using a filtered beegoormadapter
...
// GetAdapter gets the current beegoormadapter.
func (e *Enforcer) GetAdapter() persist.Adapter {
	return e.adapter
}

// SetAdapter sets the current beegoormadapter.
...
func (e *Enforcer) LoadFilteredPolicy(filter interface{}) error {
	...
	default:
		return errors.New("filtered policies are not supported by this beegoormadapter")
	}
...
// EnableAutoSave controls whether to save a policy rule automatically to the beegoormadapter when it is added or removed.
